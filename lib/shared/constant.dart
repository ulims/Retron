...
const Color textColor100 = Color(0xffFFFFFF);
const Color textColor80 = Color(0xffEEEEEE);
const Color textColor60 = Color(0xffBCBCBC);
const Color textColor40 = Color(0xff8C8C8C);
const Color textColor20 = Color(0xff7B7B7B);
const Color textColor10 = Color(0xff656565);
const Color textColor5 = Color(0xff4B4B4B);
const Color inputColor = Color(0xff121214);
const Color gradient1 = Color(0xffB1E8ED);
